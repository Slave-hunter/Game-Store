...
function Header() {
  ...
  return (
    <div className="flex items-center p-3">
      ...
      <div className="flex bg-green-300 mx-5 w-full p-2 rounded-full items-center px-2">
      ...
      {theme=='dark'?  <HiSun className="text-[35px] cursor-pointer
       bg-yellow-200 text-black p-1 rounded-full " 
        onClick={()=>setTheme('light')} />
        :
        <HiMoon className="text-[35px] cursor-pointer bg-zinc-400 text-black p-1 rounded-full" 
